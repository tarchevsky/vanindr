		...
		<FadeIn className={cn(styles.coloredgrid, 'relative py-16 mb-16 xl:mb-0')}>
			...
			>
				...
				>
					...
					надо будет озаботиться решением по походному биотуалету, сделать
					ширму.
				</div>
				<div
					className={cn(
				...
				>
					Некоторые из локаций больше подходят для курсирования возле пляжа на
					сапах, а в одной из них вообще имеется бар, баня и активные виды
					спорта. Прогноз погоды ежедневно меняется. Будем смотреть.
				</div>
				<div
					className={cn(
						styles.square,
