		...
		<>
			...
			>
				...
				<div className={cn(styles.text)}>
					Мы будем рады, если вы примете активное участие в организации данного
					события, чтобы создать праздник своими руками!
					<br />
					<br />
					Как можно помочь? В планах распределить необходимые предметы и
					продукты между всеми туристами. Например, кто-то принесет один вид
					шашлыка, кто-то другой, еще кто-то - арбуз. Большинство реквизита,
					такие как походные чайники и котелки, уже имеются в нашем арсенале. Но
					обязательно каждому нужно взять с собой походную миску, чашку, вилку,
					ложку; спальник, купальник.
					<br />
					<br />
