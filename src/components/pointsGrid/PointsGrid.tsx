		...
		<div className='grid sm:grid-cols-2 xl:grid-cols-3 gap-24 mb-16 p-6 md:p-0'>
			...
			<div className='relative'>
				...
				<p>
					...
					проходим по списку, у кого что имеется
				</p>
			</div>
			<div className='relative'>
				<div className='absolute -z-10 h-full w-full -left-4 -top-4 text-6xl font-extrabold text-neutral-200'>
			...
			<div className='relative'>
				...
				<p>
					Купаемся, разводим костер, готовим еду в том числе на газовых
					горелках, проводим вечерние игровые активности, поздравляем именинника
				</p>
			</div>
			<div className='relative'>
				<div className='absolute -z-10 h-full w-full -left-4 -top-4 text-6xl font-extrabold text-neutral-200'>
				...
				<p>
					После танцев, вечерней болтовни и большого праздника расходимся по
					кроваткам. Утром желающих ждет завтрак на костре и продолжение отдыха.
				</p>
			</div>
		</div>
	)
